...
![Search Access Work or School](Images/Join_DC/Search-add.png)
...
![Access Work or School](Images/Join_DC/connect.png)
...
![Join Local Active Directory](Images/Join_DC/alternate_actions.png)
...
![Enter Domain Name](Images/Join_DC/join_doamain-name.png)
...
![Domain Credentials](Images/Join_DC/enter-creds.png)
...
![Restart Required](Images/Join_DC/rebooted_after-login.png)
...
![Login Using Domain User](Images/Join_DC/login_to_e-corp_domain_as-tyrell.png)
...
![Preparing User Profile](Images/Join_DC/log-in-successful-to-domain.png)
...
![Computer Management](Images/Join_DC/computer-management.png)
...
![Administrators Group](Images/Join_DC/add-user.png)
...
![Create Share Folder](Images/Share/Create%20Share%20Folder.png)
...
![Folder Properties](Images/Share/click_on_share.png)
...
![Sharing Tab](Images/Share/advanced_sharing.png)
...
![Share with Everyone](Images/Share/share_everyone.png)
...
![Enable Network Discovery](Images/Share/yes-on-all-networks.png)
...
![Sharing Complete](Images/Share/done.png)
